#!/usr/bin/env python
"""Train or evaluate one task-specific age-aware readout model."""
...
from football_hgt_targets_v4.age_pooling_study import TRAINED, checkpoint_path, lock_path  # noqa: E402
...
from football_hgt_targets_v4.partial_sharing_study import training_dir as mean_training_dir  # noqa: E402
...
def main() -> None:
    ...
    config = FixedBudgetConfig(
        ...
        secondary_guard_reference_path=mean_training_dir(args.seed) / "result.json",
    )
    result = (
