...
OUT="$ROOT/experiments/task_age_propagation_v1/background"
UNIT="football-hgt-v4-age-propagation"
mkdir -p "$OUT"
...
systemd-run --user --unit "$UNIT" --collect \
  ...
  /home/li/anaconda3/bin/python "$ROOT/scripts/run_age_propagation_matrix.py" \
